...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of myledTask02 */
  osThreadDef(myledTask02, StartledTask02, osPriorityHigh, 0, 128);
  myledTask02Handle = osThreadCreate(osThread(myledTask02), NULL);
